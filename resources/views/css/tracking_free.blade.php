<style amp-custom="">
  ...
  * {
  ...
  .gallery-base-container {
    position: relative;
    width: calc(0.46 * 100vw + 9.375 * 1.025rem);
    max-width: 50rem;
  }
  .gallery-base-invert {
    color: #fff;
  ...
  .gallery-inner-3d-row-img-right amp-img {
    ...
    box-shadow: 0 30px 60px rgba(6, 7, 22, 0.15);
  }
  .gallery-inner-3d-row-img-left {
    width: 80%;
    left: -10%;
  ...
  .gallery-inner-3d-row-img-right:hover amp-img {
    ...
    box-shadow: 0 30px 80px rgba(6, 7, 22, 0.15);
  }
  @media (min-width: 52.06rem) {
  ...
  .gallery-related-section-items li:first-child .gallery-recommended-image {
    ...
    box-shadow: 1vh 6vh 5vh rgba(6, 7, 22, 0.15);
  }
  .gallery-related-section-items
    li:nth-child(2)
    ...
    box-shadow: 0.5vh 3vh 4vh rgba(6, 7, 22, 0.15);
  }
  .gallery-related-section-items
    li:nth-child(3)
    .gallery-recommended-image {
    ...
    transform-origin: 0 0;
    box-shadow: 1.5vh 4vh 5vh rgba(6, 7, 22, 0.15);
  }
  .gallery-recommended-image {
    background: #eee;
    transform-origin: 0 0;
  ...
  .gallery-related-section-items li:hover .gallery-recommended-image {
    box-shadow: 1.5vh 7vh 6vh rgba(6, 7, 22, 0.15);
  }
  ...
  .gallery-landing-image-wrap:nth-child(2)
    .gallery-landing-image-transform {
    width: 100%;
    height: 100%;
    transform: matrix3d(
      1.444379,
  ...
  .gallery-landing-image-wrapped:focus
    .gallery-landing-image-caption-content,
  .gallery-landing-image-wrapped:hover
    .gallery-landing-image-caption-content {
    opacity: 1;
    pointer-events: auto;
  ...
  .gallery-landing-image-wrapped:nth-child(8n-1)
    .gallery-landing-image-caption-content {
    background: #e63c09;
  }
  .gallery-landing-image-wrapped:nth-child(8n-1)
  ...
  .gallery-landing-image-wrapped:nth-child(8n-2)
    .gallery-landing-image-caption-content {
    background: #b812ab;
  }
  .gallery-landing-image-wrapped:nth-child(8n-2)
  ...
  .gallery-landing-image-wrapped:nth-child(8n-3)
    .gallery-landing-image-caption-content {
    background: #eb4d68;
  }
  .gallery-landing-image-wrapped:nth-child(8n-3)
  ...
  .gallery-landing-image-wrapped:nth-child(8n-4)
    .gallery-landing-image-caption-content {
    background: #1b5b17;
  }
  .gallery-landing-image-wrapped:nth-child(8n-4)
  ...
  .gallery-landing-image-wrapped:nth-child(8n-5)
    .gallery-landing-image-caption-content {
    background: #4a145b;
  }
  .gallery-landing-image-wrapped:nth-child(8n-5)
  ...
  .gallery-landing-image-wrapped:nth-child(8n-6)
    .gallery-landing-image-caption-content {
    background: #2d646e;
  }
  .gallery-landing-image-wrapped:nth-child(8n-6)
  ...
  .gallery-landing-image-wrapped:nth-child(8n-7)
    .gallery-landing-image-caption-content {
    background: #25b841;
  }
  .gallery-landing-image-wrapped:nth-child(8n-7)
  ...
  .gallery-landing-image-wrapped:nth-child(8n)
    .gallery-landing-image-caption-content {
    background: #06345e;
  }
  .gallery-landing-image-wrapped:nth-child(8n)
  ...
  .gallery-sidebar[side] {
    background: #fff;
    transition: transform 0.3s cubic-bezier(0, 0, 0.21, 1), box-shadow 0.3s;
  }
  .gallery-sidebar[open] {
    box-shadow: 0 0 2rem rgba(6, 7, 22, 0.15);
  }
  @media (min-width: 40.06rem) and (min-height: 40.06rem) {
  ...
  .ampstart-sidebar-header {
    font-weight: 300;
    margin: 2rem 0 calc(1.25rem * 0.925);
  }
  ...
  @media (-webkit-min-device-pixel-ratio: 1.5), (min-resolution: 144dpi) {
    .ampstart-nav-item:nth-child(2) .ampstart-nav-link {
      border: none;
      background: linear-gradient(180deg, #000, #000 50%, #fff 0) 0 0/100%
          1px no-repeat,
        linear-gradient(180deg, #000, #000 50%, #fff 0) 0 100%/100% 1px
          no-repeat;
    }
    .ampstart-nav-item:nth-child(2) .ampstart-nav-link:after {
      top: 0;
  ...
  .text-gray-light-mktg-link {
    color: #8193b2;
  }
  .text-gray-light-mktg-link:hover {
    color: #fff;
  }
  .pbxz10{
    padding-top: 3rem;
  ...
  .round-nav-logo{
    ...
    width: 90px;
    height: 90px;
    -webkit-box-shadow: #ffe57f 0 -1px 4px, #ffe57f 0 -2px 10px, #ff7170 0 -10px 20px, #ffe57f 0 -18px 40px, 5px 5px 38px -1px rgba(0,0,0,0);
    box-shadow: #ffe57f 0 -1px 4px, #ffe57f 0 -2px 10px, #ff7170 0 -10px 20px, #ffe57f 0 -18px 40px, 5px 5px 38px -1px rgba(0,0,0,0);
  }

  .round-nav-logo-small{
    border-radius: 60px;
    width: 40px;
    height: 40px;
    -webkit-box-shadow: #ffe57f 0 -1px 4px, #ffe57f 0 -2px 10px, #ff7170 0 -10px 20px, #ffe57f 0 -18px 40px, 5px 5px 38px -1px rgba(0,0,0,0);
  ...
  .link-dark {color: #040d21;border-bottom: 2px solid rgba(4,13,33, 0.15);text-decoration: none;-webkit-transition: 0.35s;transition: 0.35s;}
  .link-dark:hover {border-bottom-color: rgba(4,13,33, 0);background: rgba(4,13,33, 0.2);}
  .link-light {color: #8193b2;border-bottom: 2px solid rgba(255, 225, 225, 0.15);text-decoration: none;-webkit-transition: 0.35s;transition: 0.35s;}
  .link-light:hover {border-bottom-color: rgba(255, 255, 255, 0);background: rgba(255, 255, 255, 0.2);}
  .n-link {color: #8193b2; border-bottom: 2px solid rgba(255, 225, 225, 0.15);text-decoration: none;-webkit-transition: 0.35s;transition: 0.35s;}
  .n-link:hover {color: #8193b2; border-bottom-color: rgba(255, 255, 255, 0);background: rgba(255, 255, 255, 0.2);}
  .togglebtn{
    display: inline-block;
    padding: 13px 20px;
    color: #fff;
  ...
  .selectatopic {
      ...
      position: relative;
      box-shadow: 0 20px 45px rgba(6, 7, 22, .13);
      margin-top: 35px;
  }
  .jump {
      font-size: 16px;
      padding: 19px 8px 8px 48px;
